...
updatedItems = [updateItem(item) for item in menuItems]

keys = updatedItems[0].keys()
with open('FawzyMenu.csv', 'w', newline='') as output_file:
    dict_writer = csv.DictWriter(output_file, keys)
    dict_writer.writeheader()
    dict_writer.writerows(menuItems)
