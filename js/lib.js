...
window.onload = function() {
  ...
  populateMenuItem(menuItems, "Starter", "food")
  populateMenuItem(menuItems, "Rice", "food")
  populateMenuItem(menuItems, "Swallow", "food")
  populateMenuItem(menuItems, "Protein", "food")
  populateMenuItem(menuItems, "Soup", "food")
  populateMenuItem(menuItems, "Side Dishes", "food")
...
const populateMenuItem = (menuItems, subCategory, parentId) =>{
  ...
  categoryElement.innerHTML = `<h5>${subCategory} </h5></b>`
